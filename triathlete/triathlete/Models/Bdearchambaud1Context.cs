...
public partial class Bdearchambaud1Context : DbContext
{
    public Bdearchambaud1Context()
    {
    }

    public Bdearchambaud1Context(DbContextOptions<Bdearchambaud1Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=192.168.4.1;port=3306;user=sqlearchambaud;password=savary;database=bdearchambaud1;sslmode=none", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.5.18-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LicenceClub>(entity =>
        {
            ...
            entity.HasOne(d => d.ClubIdEntrainerNavigation).WithMany(p => p.LicenceClubClubIdEntrainerNavigations)
